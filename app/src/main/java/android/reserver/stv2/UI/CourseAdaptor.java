...
/**
 * This class is an adaptor for the recycleView layout course list. It extends the RecyclerView.
 * Adaptor class.
 */
public class CourseAdaptor extends RecyclerView.Adapter<CourseAdaptor.CourseViewHolder> {
    ...
    class CourseViewHolder extends RecyclerView.ViewHolder{
        // creates a TextView variable to store the courseItemView
        ...
        private CourseViewHolder (View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // creates an intent to proceed to the AssessmentList class
                    Intent intent = new Intent(context, android.reserver.stv2.UI.AssessmentList.class);
                    // passes course object parameters through the intent
    ...
    private List<Course> mCourse;  // creates a list variable to hold the courses
    ...
    public CourseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = mInflater.inflate(R.layout.layout_list_courses, parent, false);
        return new CourseViewHolder(itemView); // the view returned
    }
    /**
    ...
    public void onBindViewHolder(CourseViewHolder holder, int position) {
        ...
        if(mCourse != null) { // if mCourse is not null
            Course current = mCourse.get(position); // assigns the course to a class variable
            // sets the text of the ItemView with the courseName
     ...
     * @param courses the course used
     */
    public void setCourses (List<Course> courses) {
        mCourse = courses; // assigns the courses to class variable
    ...
    public int getItemCount() {
        // branch statement
        if (mCourse != null) // if mCourse is not null
            return mCourse.size(); // return size
